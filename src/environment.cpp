...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
  ...
  // Filtering
  pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.2 , Eigen::Vector4f (-20, -6, -3, 1), Eigen::Vector4f ( 30, 7, 2, 1));
  ...
  //CLuster
  std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = PointProcessor.Clustering(segmentCloud.first, 0.35, 10, 750);
